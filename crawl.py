...
- ★ 과거 수치/사례 인용 시 확실하지 않으면 절대 구체적 숫자를 단정하지 말 것. "~한 적이 없다", "역대 최초" 같은 단정 표현 금지
- 숫자는 데이터 그대로 인용
- 총 800~1200자 분량
...
- ★ 과거 수치/사례 인용 시 확실하지 않으면 절대 구체적 숫자를 단정하지 말 것. "~한 적이 없다", "역대 최초" 같은 단정 표현 금지. 불확실하면 "과거 고점 대비" 등 추상적으로 표현
