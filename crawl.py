...
## 목표:
현재 시점 기준으로 뉴스/거래대금/검색량 기반
핫한 국내 주식 테마 상위 10개를 선정한다.
...
## 규칙:
1. 추측 금지. 불확실하면 "확인 필요"라고 표시
2. 종목명 오기재 시 다시 검증 후 수정하여 출력하라
3. 동일 종목 중복 금지
4. 테마와 직접 연관된 종목만 포함하라
5. 종목코드는 반드시 위 참고 리스트 또는 실제 존재하는 6자리 숫자 코드 사용
6. market은 "KOSPI" 또는 "KOSDAQ"
